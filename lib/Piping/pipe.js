...
/*
stream.pipeline() will call stream.destroy(err) method on all streams except:
1. Readable Streams which have emitted 'end' or 'close'.
2. Writable Streams which have emitted 'finish' or 'close' event
 */